 ...
 * CLI version: 2.11.0
 * 
 * Generated: Wed, 14 Jun 2023 17:40:19 GMT
 */

var APP_diagnal_workshop = (function () {
  'use strict';
  ...
  class ContentCard extends Lightning$1.Component {
    static _template() {
      return {
        w: 150,
        h: 250,
        ...
        Thumbnail: {
          ...
          Contain: {
            ...
            ThumbnailBorder: {
              ...
              y: h => h / 2,
              mount: 0.5,
              texture: Lightning$1.Tools.getRoundRect(155, 235, 5, 6, 0xff00ff0c, false)
            }
          }
        },
        AssetTitle: {
    ...
    set contentData(data) {
      ...
      this.tag("Thumbnail.Contain").src = Utils.asset("images/slices/" + (data["poster-image"] ? data["poster-image"] : "placeholder_for_missing_posters.png"));
  ...
  class HomePage extends Lightning$1.Component {
    ...
    $updateContentDetails(cdetails) {
      var _cdetails$description;
      this.cTitle = cdetails.name;
      this.cDesc = (_cdetails$description = cdetails === null || cdetails === void 0 ? void 0 : cdetails.description) !== null && _cdetails$description !== void 0 ? _cdetails$description : "";
  ...
  class App extends Lightning$1.Component {
    static getFonts() {
      return [{
        ...
        family: 'SemiBold',
        url: Utils.asset('fonts/TitilliumWeb-SemiBold.ttf')
      }, {
        family: 'ExtraLight',
        url: Utils.asset('fonts/TitilliumWeb-ExtraLight.ttf')
      }];
    }
    static _template() {
      return {
    ...
    _active() {
      ...
      this.currentTime = timeNow.toTimeString(navigator.language, {
        hour: '2-digit',
        minute: '2-digit'
      }).substring(0, 5);
